...
from decklists import olaf,pascal,wardrobe,captain_hook,aurora,maleficent,fire_the_cannons,dinglehopper
...
class BasicGameGenerator:
    ...
    def draw_opening_hand(self):
        ...
        p1_hand=[olaf,olaf,olaf,pascal,pascal,wardrobe, wardrobe]
